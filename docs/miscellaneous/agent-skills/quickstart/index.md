...
- **[Best practices](/miscellaneous/agent-skills/best-practices/)** — how to write skills that are well-scoped and effective.
- **[Optimizing descriptions](/miscellaneous/agent-skills/optimizing-descriptions/)** — test and improve your skill's description so it activates on the right prompts.
- **[Specification](/miscellaneous/agent-skills/specification/)** — the complete format reference for `SKILL.md` files.
